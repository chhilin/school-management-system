        ...
        <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" placeholder="Input Phone Number" class="form-control" name="phone_number" id="phone_number" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mt-4">
                <div class="d-flex justify-content-end gap-3">
                    <button type="submit" class="btn btn-danger"><a href="{{ route('teachers.list')}}" class="text-decoration-none text-white">Cancel</a> </button>
